...
## Tech Stack
codehugger/Flask-Session is built on the following main stack:
...
# Tech Stack File
![](https://img.stackshare.io/repo.svg "repo") [codehugger/Flask-Session](https://github.com/codehugger/Flask-Session)![](https://img.stackshare.io/public_badge.svg "public")
<br/><br/>
...
|:------|:------|:------|:------|:------|:------|
|[redis](https://pypi.org/project/redis)|N/A|09/26/12|Bjarki Guðlaugsson |MIT|N/A|
